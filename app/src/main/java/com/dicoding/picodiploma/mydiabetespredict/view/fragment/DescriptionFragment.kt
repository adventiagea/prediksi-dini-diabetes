...
class DescriptionFragment : Fragment() {
    override fun onCreateView(
        ...
        val button = view.findViewById<Button>(R.id.yes_desc)
        val back = view.findViewById<ConstraintLayout>(R.id.back7)
        ...
        button.setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.desc_ke_pertanyaan1)
        }
