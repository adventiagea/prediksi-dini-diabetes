...
class NegativeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_negative, container, false)
        val back = view.findViewById<ConstraintLayout>(R.id.back2)
        val back2 = view.findViewById<Button>(R.id.kembali_2)
